...
const NavMenuUl = styled.ul<{ shop: boolean }>`
    display: flex;
...
const NavMenuA = styled.a<{ signbtn?: boolean }>`
    padding: 0 10px;
    color: ${({ signbtn }) => (!signbtn ? 'darkslategray' : 'white')};
    cursor: pointer;
        ...
        <MenuWraper>
            <MenuWwrapperContent>
                ...
                <NavMenuUl shop={true}>
                    ...
                    <li>
                        <NavMenuA signbtn>Sing Up</NavMenuA>
                    </li>
                </NavMenuUl>
            </MenuWwrapperContent>
        </MenuWraper>
